...
const questions: Partial<Record<PublicPath, [string, string][]>> = {
 '/weddings': [
  ['Do you create wedding flowers across Hampshire?', 'Yes. Bramble & Petal is based in Southampton and creates wedding flowers across Hampshire. Include your venue and date in your enquiry so we can confirm availability, delivery and setup arrangements.'],
 ...
 '/funerals': [
  ['Can you help with funeral flowers in Southampton and Hampshire?', 'Yes. Tell us the service date, location and the tribute you have in mind. We will confirm availability and delivery arrangements with you, including any details needed for the funeral director or venue.'],
 ...
 '/corporate': [
  ['Do you provide event flowers throughout Hampshire?', 'Yes. We work with businesses and event clients across Hampshire from our Southampton studio. Share the venue, date, spaces to be dressed and any brand colours so we can discuss the brief.'],
