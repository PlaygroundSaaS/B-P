...
comment on table public.studio_app_state is 'Private Bramble and Petal Studio workspace state. Accessed only by the server after custom Studio authentication.';
